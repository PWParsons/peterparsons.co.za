...
{#if externalLink}
  <a
    ...
    target="_blank"
    rel="noreferrer"
    class="text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-madison/50 hover:text-slate-900 dark:hover:text-slate-300 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
  >
    <slot />
    <svg
