...
<nav class="flex-1 px-2 space-y-8 bg-white dark:bg-black-pearl" aria-label="Sidebar">
    <div class="space-y-1">
        <NavigationItem>
            <svg class="text-slate-500 mr-3 flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <NavigationItem>
            <svg class="text-slate-500 group-hover:text-slate-500 mr-3 flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    ...
    <div class="space-y-2">
        ...
        <div class="space-y-1" role="group" aria-labelledby="writings-headline">
            ...
            <NavigationItem>
                <svg class="text-slate-500 group-hover:text-slate-500 mr-3 flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="space-y-2">
        ...
        <div class="space-y-1" role="group" aria-labelledby="online-headline">
            <NavigationItem>
                <svg class="text-slate-500 group-hover:text-slate-500 mr-3 flex-shrink-0 h-4 w-4" viewBox="0 0 16 14" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                ...
                Twitter
                <svg class="text-slate-500 group-hover:text-slate-500 mr-1 ml-auto flex-shrink-0 w-3 h-3" viewBox="0 0 10 9" fill="none" xmlns="http://www.w3.org/2000/svg">
