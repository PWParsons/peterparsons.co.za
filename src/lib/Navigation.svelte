<nav class="flex-1 px-2 space-y-8 bg-white" aria-label="Sidebar">
    <div class="space-y-1">
        <a href="/" class="bg-slate-100 text-slate-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
    ...
    <div class="space-y-2">
        ...
        <div class="space-y-1" role="group" aria-labelledby="online-headline">
            <a href="/" class="text-slate-600 hover:bg-slate-50 hover:text-slate-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                <svg class="text-slate-400 group-hover:text-slate-500 mr-3 flex-shrink-0 h-4 w-4" viewBox="0 0 16 14" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                ...
                Twitter
                <svg class="text-slate-400 group-hover:text-slate-500 mr-1 ml-auto flex-shrink-0 w-3 h-3" viewBox="0 0 10 9" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/" class="text-slate-600 hover:bg-slate-50 hover:text-slate-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                <svg class="text-slate-400 group-hover:text-slate-500 mr-3 flex-shrink-0 h-4 w-4" viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
