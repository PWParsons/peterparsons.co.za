...
<nav class="mt-5 flex-1 px-2 space-y-8 bg-white dark:bg-black-pearl" aria-label="Sidebar">
  <div class="space-y-1">
    <NavigationItem>
      <svg
        class="text-slate-400 dark:text-slate-500 group-hover:text-slate-500 mr-3 flex-shrink-0 h-5 w-5"
  ...
  <div class="space-y-2">
    ...
    <div class="space-y-1" role="group" aria-labelledby="online-headline">
      <NavigationItem externalLink={true} link="https://twitter.com/">
        <svg
          class="text-sky-400 mr-3 flex-shrink-0 h-4 w-4"
          viewBox="0 0 16 14"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
        >
      ...
      <NavigationItem externalLink={true} link="https://github.com/">
        <svg
          class="text-slate-900 dark:text-white mr-3 flex-shrink-0 h-4 w-4"
          viewBox="0 0 17 16"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
        >
