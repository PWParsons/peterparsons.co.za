        ...
        <div class="sticky top-0 z-10 flex-shrink-0 flex h-14 bg-white dark:bg-black-pearl border-b border-slate-200 dark:border-mirage">
            ...
            <div class="flex-1 px-4 flex justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    {:else}
                        <button on:click="{() => toDarkMode()}" in:fly="{{ x: 30, duration: 200 }}" type="button" class="p-1 rounded-full text-slate-400 hover:text-slate-500 focus:outline-none focus:ring-0">
