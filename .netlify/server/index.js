...
const Root = (0, import_index_152afe8f.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_152afe8f.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_152afe8f.v)(components[0] || import_index_152afe8f.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_152afe8f.v)(components[1] || import_index_152afe8f.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${components[3] ? `${(0, import_index_152afe8f.v)(components[2] || import_index_152afe8f.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {
            default: () => {
              return `${(0, import_index_152afe8f.v)(components[3] || import_index_152afe8f.m, "svelte:component").$$render($$result, Object.assign(props_3 || {}), {}, {})}`;
            }
          })}` : `${(0, import_index_152afe8f.v)(components[2] || import_index_152afe8f.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`}`;
        }
      })}` : `${(0, import_index_152afe8f.v)(components[1] || import_index_152afe8f.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_152afe8f.v)(components[0] || import_index_152afe8f.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
